import React, { useState, useRef, useContext, useCallback,Suspense , lazy} from "react";
...
const MainHeader = lazy(() =>
  import('../../components/main-header/main-header.components').then(module => ({
    default: module.MainHeader
  }))
);

const ResturantInfoCard = lazy(() =>
  import('../../components/resturant-info/resturant-info.components').then(module => ({
    default: module.ResturantInfoCard
  }))
);
