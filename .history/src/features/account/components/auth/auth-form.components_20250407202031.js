					...
					>
						...
						{mode === "login" && (
							...
							>
								...
								<Pressable onPress={() => handleNavigation("Register")} style={({ pressed }) => [{padding:20},pressed&&{backgroundColor:colors.ui.accent,}]}>
									<Text
										style={{
											fontFamily: fonts.monospace,
											fontSize: 16,
						...
						{mode === "register" && (
							...
							>
								...
								<Pressable onPress={() => handleNavigation("Login")} style={({ pressed }) => [{padding:20},pressed&&{backgroundColor:colors.ui.accent,}]}>
