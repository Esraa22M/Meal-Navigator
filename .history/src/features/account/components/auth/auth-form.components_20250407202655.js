					...
					>
						...
						{mode === "login" && (
							...
							>
								...
								<Pressable onPress={() => handleNavigation("Register")} style={({pressed})=>[pressed&&{backgroundColor:colors.ui.accent, borderRadius:3}]}>
									<Text
										style={{
											fontFamily: fonts.monospace,
											fontSize: 16,
						...
						{mode === "register" && (
							...
							>
								...
								<Pressable onPress={() => handleNavigation("Login")} style={({pressed})=>[pressed&&{backgroundColor:colors.ui.accent, borderRadius:3}]}>
									<Text
										style={{
											fontFamily: fonts.monospace,
											fontSize: 16,
