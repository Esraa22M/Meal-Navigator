...
Here are some demo screenshots of the **MealNavigator App** showcasing different features and screens:

<p align="center">
  <img src="./assets/demo/img2.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
  <img src="./assets/demo/img3.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
  <img src="./assets/demo/img4.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
</p>

<p align="center">
  <img src="./assets/demo/img5.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
  <img src="./assets/demo/img6.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
  <img src="./assets/demo/img7.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
</p>

<p align="center">
  <img src="./assets/demo/img8.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
  <img src="./assets/demo/img9.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
  <img src="./assets/demo/img10.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
</p>

<p align="center">
  <img src="./assets/demo/img11.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
  <img src="./assets/demo/img12.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
  <img src="./assets/demo/img13.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
</p>

<p align="center">
  <img src="./assets/demo/img14.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
  <img src="./assets/demo/img15.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
  <img src="./assets/demo/img16.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
</p>

<p align="center">
  <img src="./assets/demo/img17.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
  <img src="./assets/demo/img18.jpeg" width="200" style="margin: 10px; border-radius: 10px;" />
</p>
